...
void remove_chars(StringExerciser *StrTester, std::string teststr, std::string blacklist, bool case_sensitive) {
...
void run_string_tests(std::vector<std::pair<std::string, std::string>> &src_filter_list, bool case_sensitive) {
